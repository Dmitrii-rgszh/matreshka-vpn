...
def populate_test_servers():
    ...
    test_servers = [
        ("moscow-1", "Москва #1", "Россия", "Москва", "🇷🇺", 15, 45, False, True),
        ("spb-1", "Санкт-Петербург #1", "Россия", "СПб", "🇷🇺", 28, 32, False, False),
        ("novosibirsk-1", "Новосибирск #1", "Россия", "Новосибирск", "🇷🇺", 65, 18, False, False),
        ("amsterdam-1", "Амстердам #1", "Нидерланды", "Амстердам", "🇳🇱", 75, 55, True, False),
        ("singapore-1", "Сингапур #1", "Сингапур", "Сингапур", "🇸🇬", 145, 28, True, False),
        ("usa-1", "Нью-Йорк #1", "США", "Нью-Йорк", "🇺🇸", 120, 67, True, False),
    ]
